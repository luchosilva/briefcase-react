  ...
  return (
    <nav className="flex justify-between items-center h-20 py-4 bg-blue-600-color px-7">
      <div className="flex">
        ...
        {i18n.language === 'es' ? <div className="w-12 min-w-[40px] rounded-md hover:text-blue-color">🇪🇸</div> : <div className="w-12 min-w-[40px] rounded-md hover:text-blue-color">🇺🇸</div>}
      </div>
